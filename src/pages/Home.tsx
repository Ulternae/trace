...
const Home = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-perl-200 to-perl-400 dark:from-liwr-800 dark:to-black w-full min-h-screen h-auto px-4 pt-20 pb-8 md:pt-8 md:grid grid-cols-[250px_1fr] gap-4">
      <div>
        <Sidebar 
